...
Satish. Yes, we are, sorry. I got lost there, but that's why we have editing. Yes, so we got Bethany and Satish. ⁓ We are joined this week by Satish Saley a senior software engineer who spent years on DoorDash's search platform team where he co-authored two major engineering transformations. First, rebuilding the search indexing pipeline with Kafka.
...
Brittany Ellich (04:56)
That's cool. Bethany, do you have any experience with like scrappy initial startups of growing from there? Or I can't remember exactly where you worked at your last job, but I remember it was smaller than GitHub, so.
...
Brittany Ellich (09:18)
Gotcha. Interesting. So did you know going into it, so I think from what I read, the Elasticsearch introduction was in 2021 and then the homegrown engine was in 2024. Is that right? Or? Okay. Did you know going into the Elasticsearch part that like this was likely something that was going to be replaced or wouldn't scale past a certain point? Or did you, was it like a stepping stone or like a final thing when you did it?

Satish (09:33)
Yeah, yeah, yeah, I think it up here it is
...
Satish (29:46)
⁓ Yeah, so for your last questions how I'm getting up to the speed ⁓ I think ⁓ by using a lot of AI tools like Copilot, ⁓ internally clean, there is a cloud code, there are like bunch of other things. So ⁓ definitely like a lot of reading but if you are curious enough to know about anything I think it's just like a question away.
...
then whatever money it is costing, I would multiply by that 10 if it is costing you the velocity. Then in terms of operability ⁓ of that system, ⁓ what is, how much effort that the eng team is putting in into operating that system. Not only eng team, maybe like the product team, whoever is like ⁓ making efforts in operating into that system. So that also put like a...
...
Brittany Ellich (48:15)
Ugh.

Satish (48:20)
Okay

Brittany Ellich (48:20)
smart, so the
